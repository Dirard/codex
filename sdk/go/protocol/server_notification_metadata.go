...
var ServerNotificationRoutingByMethod = map[string]ServerNotificationRoutingMetadata{
	...
	"project/changed":                           {Method: "project/changed", PayloadType: "ProjectChangedNotification", PayloadSchemaRef: "#/definitions/ProjectChangedNotification", Visibility: "public", SchemaExcludedReason: "", ManualPayloadConversion: "", RoutingKind: "routed", Experimental: false, Routes: []ServerNotificationRouteMetadata{{ResourceDomain: "project", WireIdentitySource: "project/changed", IdentityExtractors: []ServerNotificationIdentityExtractor{{FieldPath: "projectId", IdentityName: "projectId", Optional: false, TerminalPredicateJSON: ""}}}}},
