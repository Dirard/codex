...
var ServerNotificationRoutingByMethod = map[string]ServerNotificationRoutingMetadata{
	...
	"rawResponse/completed":                     {Method: "rawResponse/completed", PayloadType: "RawResponseCompletedNotification", PayloadSchemaRef: "#/definitions/RawResponseCompletedNotification", Visibility: "generatedOnly", SchemaExcludedReason: "raw response completion is stripped from the generated JSON ServerNotification method union", ManualPayloadConversion: "", RoutingKind: "routed", Experimental: false, Routes: []ServerNotificationRouteMetadata{{ResourceDomain: "rawResponse", WireIdentitySource: "rawResponse/completed", IdentityExtractors: []ServerNotificationIdentityExtractor{{FieldPath: "threadId", IdentityName: "threadId", Optional: false, TerminalPredicateJSON: ""}, {FieldPath: "turnId", IdentityName: "turnId", Optional: false, TerminalPredicateJSON: ""}}}}},
...
func DecodeServerNotificationPayload(method string, params json.RawMessage) (any, error) {
	...
	case "rawResponse/completed":
		var payload RawResponseCompletedNotification
		if err := json.Unmarshal(params, &payload); err != nil {
			return nil, err
		}
		return payload, nil
